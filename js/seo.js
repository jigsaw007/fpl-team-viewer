...
(function(){
  const ROUTES={
    ...
    transferstats:{path:"/transfer-stats",title:"FPL Transfer Stats - Most Transferred In & Out | FPL Peek",description:"Track official FPL transfers in, transfers out and net transfer movement by player for the current Gameweek or the full season."},
