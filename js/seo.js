...
(function(){
  const ROUTES={
    ...
    planner:{path:"/gameweek-planner",title:"FPL Gameweek Planner - Transfers, Chips & Captains | FPL Peek",description:"Plan FPL transfers across future Gameweeks, carry squads forward, choose captains and chips, and compare projected versus actual points without changing your real team."},
